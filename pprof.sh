...
docker run -d --name socat --network net_ccperf --publish 7062:7062 alpine/socat tcp-listen:7062,fork,reuseaddr tcp-connect:dev-peer1.org1.example.com-ccperf-v1:6060
